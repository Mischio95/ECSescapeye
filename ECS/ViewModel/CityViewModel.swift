...
var newQuestN1 = Quest(title: "Sfogliatella is the best", description: "Puff pastry Curly Neapolitans are a typical dessert of the Neapolitan pastry tradition, just like the PUFF PASTRY NEAPOLITAN, it was a lifetime that I wanted to prepare them and finally I made it, I do not hide that they are not really fast, but on the other hand if we want to enjoy a good homemade curly puff pastry we must arm ourselves with patience, layers of puff pastry stuffed with ricotta cream, semolina and candied oranges, one of the Neapolitan desserts that I love most of all together with the baba and the legendary Neapolitan pastiera.", backgroundImage: "sfogliatella", difficultyLevel: [star,star], trophy: Trophy.bronze)
var newQuestN2 = Quest(title: "Sant'Elmo's way", description: "Castel Sant'Elmo is a medieval castle, used as a museum, located on the hill of Vomero near San Martino in Naples. Once it was called Paturcium and rises in the place where there was, starting from the tenth century, a church dedicated to Sant'Erasmo (from which Eramo, Ermo and then Elmo). This mighty building (the first castle by extension of the city), partly made from the living rock (yellow Neapolitan tuff), originates from a Norman observation tower called Belforte. Due to its strategic importance, the castle has always been a very coveted possession: from its location (250 m above sea level) you can observe the whole city, the gulf, and the streets that lead from the surrounding heights to the city.", backgroundImage: "elmo", difficultyLevel: [star,star], trophy: Trophy.silver)
